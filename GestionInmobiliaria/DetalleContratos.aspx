<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DetalleContratos.aspx.vb" Inherits="GestionInmobiliaria.DetalleContratos" %>
...
<body>
    <form id="form1" runat="server">
        <div class="cuadro_general">
            ...
            <asp:TextBox ID="TextBox3" runat="server" Text="DETALLE DE CONTRATOS" ReadOnly="true" CssClass="titulo1"></asp:TextBox>
            ...
            <asp:TextBox ID="TextBox4" Placeholder="Buscar..." runat="server" CssClass="TextBoxBuscador2" OnTextChanged="TextBox4_TextChanged" AutoPostBack="True"></asp:TextBox>
            <asp:TextBox ID="TextBox5" Placeholder="Año..." runat="server" CssClass="TextBoxBuscador3" OnTextChanged="TextBox5_TextChanged" AutoPostBack="True"></asp:TextBox>
